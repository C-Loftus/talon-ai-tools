...
pilot open: user.vscode("workbench.action.chat.open")
pilot edit attach: user.vscode("github.copilot.chat.attachFile")
[pilot] edit next: user.vscode("chatEditor.action.navigateNext")
[pilot] edit last: user.vscode("chatEditor.action.navigatePrevious")
pilot hunk (keep | accept): user.vscode("chatEditor.action.acceptHunk")
pilot edit (keep | accept | file accept): user.vscode("chatEditor.action.accept")
pilot edit all files (keep | accept): user.vscode("chatEditing.acceptAllFiles")
pilot hunk (undo | reject): user.vscode("chatEditor.action.undoHunk")
pilot edit file (undo | reject): user.vscode("chatEditor.action.reject")
pilot edit all files (undo | reject): user.vscode("chatEditing.discardAllFiles")
pilot edit undo: user.vscode("workbench.action.chat.undoEdit")
